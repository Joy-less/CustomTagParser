...
public readonly record struct CustomTagUnit {
    ...
    /// <summary>
    /// A function that accepts the text preceding the tag and the text following the tag and returns a string to replace the input string.
    /// </summary>
    public required ReplaceDelegate Replace { get; init; }
    /// <summary>
    /// A function that accepts the text preceding the tag and the text following the tag and returns whether the tag unit should be applied.
    /// </summary>
    ...
    /// <summary>
    /// Constructs a new custom tag unit.
    /// </summary>
    /// <param name="Tag">The tag unit.</param>
    /// <param name="Replace">A function that accepts the text preceding the tag and the text following the tag and returns a string to replace the input string.</param>
    /// <param name="Condition">A function that accepts the text preceding the tag and the text following the tag and returns whether the tag unit should be applied.</param>
    [SetsRequiredMembers]
